...
searchBlocks(options.s, options.e).then(() => {
    ...
    if (maxMatronId.length > 0) {
        ...
        for (let i = 0; i < maxMatronId.length; i++) {
            let generation, ethGeneration;
            let birthTimeUTC, ethTimestamp;
            axios_1.default({
                'method': 'GET',
                ...
                if (response.data.kittyType)
                    console.log("Kitty type: " + response.data.kittyType);
                ...
                console.log((_a = res.genes) !== null && _a !== void 0 ? _a : "Not found.");
                ...
                .then(() => {
                var _a, _b;
                console.log((_b = (_a = "Generation: " + ethGeneration) !== null && _a !== void 0 ? _a : generation) !== null && _b !== void 0 ? _b : "unknown.");
                ...
                console.log(new Date(ethTimestamp) + ": " + (new Date(parseInt(ethTimestamp) * 1000)).toUTCString());
                console.log(birthTimeUTC + ": " + (new Date(birthTimeUTC).toUTCString()));
            });
        }
    }
    else {
